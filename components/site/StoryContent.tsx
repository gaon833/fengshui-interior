...
import FabricDocumentViewer from "@/components/fabric/FabricDocumentViewer";
export default function StoryContent(){
 ...
 if(content.fabric?.desktop?.pages?.length || content.fabric?.mobile?.pages?.length) return <FabricDocumentViewer document={content.fabric} label="OUR STORY"/>;
