...
import PolotnoViewerClient from "@/components/polotno/PolotnoViewerClient";
export default function StoryContent(){
 ...
 if(content.polotnoDesktop || content.polotnoMobile) return <PolotnoViewerClient desktop={content.polotnoDesktop||null} mobile={content.polotnoMobile||null} label="OUR STORY"/>;
