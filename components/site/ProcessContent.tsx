...
export default function ProcessContent(){
 ...
 if(content.polotnoDesktop || content.polotnoMobile) return <PolotnoViewerClient desktop={content.polotnoDesktop||null} mobile={content.polotnoMobile||null} label="PROCESS"/>;
